...
{
	// This class will be in charge of animating the scrolling of the
	// text in the text display as the words get typed.
	
	// When we get to this point, there is a class called Scroller that might do what we need.
